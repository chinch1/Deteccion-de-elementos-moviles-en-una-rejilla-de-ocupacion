...
if("FALSE" STREQUAL "TRUE")
  set(pointcloud_to_laserscan_SOURCE_PREFIX /home/nicobite/Desktop/Tesis/Deteccion-de-elementos-moviles-en-una-rejilla-de-ocupacion/catkin_ws/src/pointcloud_to_laserscan-release-debian-kinetic-xenial-pointcloud_to_laserscan)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pointcloud_to_laserscan' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nicobite/Desktop/Tesis/Deteccion-de-elementos-moviles-en-una-rejilla-de-ocupacion/catkin_ws/install/${idir}'.  ${_report}")
    endif()
