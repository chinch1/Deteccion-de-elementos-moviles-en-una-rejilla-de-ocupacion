...
nav_msgs::OccupancyGrid generate_Grid_Map(nav_msgs::OccupancyGrid gridMap) {
  ...
  vector<signed char>data(v,v+length);//Asignar luego del llenado del arreglo
  gridMap.data = data;
...
int main(int argc, char *argv[]) {
  ...
  for (int i = 1; i<argc; i++) {
    ...
    if (arg == "-h") {
      ...
      cout << "Este nodo genera la rejilla probabilistica de ocupacion \n";
      cout << "  Parametros: \n";
      cout << "\t--r\t'resolution' \n";
      cout << "\t--w\t'width' \n";
      cout << "\t--h\t'height' \n";
      cout << "\t--f\t'frame_id' \n";
      cout << "\n \n";
      cout << "Por default se genera una rejilla con:\n\n";
      cout << "\tresolution\t= 0.01 \n";
      cout << "\twidth\t\t= 10 \n";
      cout << "\theight\t\t= 10 \n";
      cout << "\tframe_id\t= map \n";
      cout << "\n\n";
  ...
  while (ok()) {
    ...
    spinOnce(); // Aqui se genera la magia
